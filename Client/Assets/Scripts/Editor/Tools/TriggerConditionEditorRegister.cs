...
public static class TriggerConditionEditorRegister
{
    ...
    static void OR(excel_trigger_condition condition, TriggerEditor editor)
    {
        CheckParamCount(condition, 2);
        ...
        condition.condParams[1] = EditorGUILayout.IntField("或者", condition.condParams[1]);
    ...
    static TriggerConditionEditorRegister()
    {
        ...
        mTriggerConditionMethods[TriggerConditionType.OR] = OR;
    }
